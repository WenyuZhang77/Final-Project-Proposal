...
Our intended final product should be a website that includes the crime reports for each of the five boroughs of NYC from 2006 to the present. From the reports, we want to see the yearly trends of crime rate in the whole city and specific areas respectively and do the prediction for the next few years.
